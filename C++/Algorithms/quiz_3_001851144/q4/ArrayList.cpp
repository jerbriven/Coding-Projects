/** Implementation file for the class ArrayList. @file ArrayList.cpp */
...
template<class ItemType>
void ArrayList<ItemType>::setEntry(int position, const ItemType& newEntry) throw(PrecondViolated)
{
   // Enforce precondition
